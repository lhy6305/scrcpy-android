...
public class ScrcpyHost implements Scrcpy.ServiceCallbacks{
    ...
    public void connect(Context context, String clientIp, int width, int height, int bitrate, boolean useAmlogicMode, Surface display) {
...
//https://stackoverflow.com/questions/6064510/how-to-get-ip-address-of-the-device-from-code
    ...
    public void onVideoSizeChanged(int width, int height) {
        ...
        if (connectCallBack != null) {
            connectCallBack.onConnect(width, height);
        }
    }
