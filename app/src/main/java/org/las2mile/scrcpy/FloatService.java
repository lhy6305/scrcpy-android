...
public class FloatService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        boolean useAmlogicMode = intent.getBooleanExtra("amlogic_mode", false);
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                startCopy(ip, w, h, b, useAmlogicMode);
            }
        }).start();
...
//        startCopy();
    ...
    private void startCopy(String ip, int width, int height, int bitrate, boolean useAmlogicMode) {
        ...
        scrcpyHost.connect(getApplicationContext(), ip, width, height, bitrate, useAmlogicMode, displayWindow.getDisplaySurface());
    }
