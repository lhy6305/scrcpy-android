...
public class AdbProtocol {
    ...
    public static final int CMD_CLSE = 0x434c5345;
    public static final int CMD_WRTE = 0x57525445;
    ...
    public static boolean validateMessage(AdbMessage msg) {
        ...
        if (msg.payloadLength != 0 && getPayloadChecksum(msg.payload) != msg.checksum) {
            return false;
        }
        return true;
    }
